...
file_path = r'G:\My Drive\my_projects\ss_max_load'
tr_file_path = os.path.join(file_path, 'tr.csv')
gen_file_path = os.path.join(file_path, '33kV_gen.csv')
tr_df = pd.read_csv(tr_file_path, index_col=[0], parse_dates=True, dayfirst=False, infer_datetime_format=True)
gen_df = pd.read_csv(gen_file_path, index_col=[0], dayfirst=False, parse_dates=True, infer_datetime_format=True)
df = pd.concat([tr_df, gen_df], ignore_index=False)
